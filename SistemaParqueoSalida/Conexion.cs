...
namespace SistemaParqueoSalida
{
    class Conexion
    {
        public SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["SistemaParqueoSalida.Properties.Settings.Conexion"].ConnectionString);
